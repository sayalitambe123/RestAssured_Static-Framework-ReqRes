...
import Common_Methods.Common_API_Methods_Post;
import Common_Methods.Common_Utility_Method;
import Request_Repository.Post_Req_Repository;
public class Post_TC {

	public static void extractor() throws IOException {
		int statusCode = Common_API_Methods_Post.ResponseStatusCode(Post_Req_Repository.BaseURI(), Post_Req_Repository.Resource()
				, Post_Req_Repository.RequestBody() );
		System.out.println("Status Code : "+statusCode);
		
		
		String responseBody = Common_API_Methods_Post.ResponseBody(Post_Req_Repository.BaseURI(), Post_Req_Repository.Resource()
				, Post_Req_Repository.RequestBody() );
		System.out.println("Response Body is : \n"+responseBody);
		
		String RequestBody = Post_Req_Repository.RequestBody();
		validator(RequestBody, responseBody);
		Common_Utility_Method.EvidenceFileCreator("PostTC", RequestBody, responseBody, statusCode);
